...
export function BookEdit() {
    ...
    function onSaveBook(ev) {
        ...
        bookService.save(bookToEdit)
            ...
            .catch(err => {
                console.log('Had issues in book edit:', err)
                showErrorMsg("Can't save book!")
            })
    }

    const { title, listPrice: { amount }, description, pageCount, language, publishedDate } = bookToEdit
    return (
        <section className="book-edit">
            ...
            <form onSubmit={onSaveBook} className="flex flex-column justify-center book-edit-form">
                ...
                <input ref={inputRef} required onChange={handleChange} value={title} type="text" name="title" id="title" />
                ...
                <textarea className="description" onChange={handleChange}
                    value={description} type="text" name="description" id="description"></textarea>
                ...
                <label htmlFor="publishedDate">Year of Published:</label>
